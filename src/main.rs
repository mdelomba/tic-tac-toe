...
impl Board {
    ...
    fn contains_winner(&self) -> Option<Player> {
        ...
        for col in 0..3 {
            if self.cells[0][col] == self.cells[1][col] && self.cells[1][col] == self.cells[2][col] && self.cells[0][col] != Cell::Empty {
        ...
        if self.cells[0][0] == self.cells[1][1] && self.cells[1][1] == self.cells[2][2] && self.cells[0][0] != Cell::Empty {
        ...
        if self.cells[0][2] == self.cells[1][1] && self.cells[1][1] == self.cells[2][0] && self.cells[0][2] != Cell::Empty {
